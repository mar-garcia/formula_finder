...
ui <- navbarPage(
  ...
  tabPanel("Instructions",
           ...
           ("The "), 
           code("Hydrogen Rule"),
           (" determines the maximum number of hydrogens that a formula can contain following the following calculation:"),
           em("Max(H) = 2C + N + 2"),
           (". Note that this rule is never applied for phosphorus containg formulas."),
           br(),
           ("The "),
           ...
           p("In the lower part of the page you can get the m/z values for different adducts given an specific formula."),
           br(),
           hr(),
           br(),
